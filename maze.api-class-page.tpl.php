...
<div role="tabpanel">
  <ul class="nav nav-pills" role="tablist">
    <li role="presentation">
      <a href="#class-api-structure" aria-controls="class-api-structure" role="tab" data-toggle="tab">Structure</a>
    </li>
    <li role="presentation" class="active">
      <a href="#class-api-code" aria-controls="class-api-code" role="tab" data-toggle="tab">Code</a>
    </li>
  </ul>

  <div class="tab-content">
    <div role="tabpanel" class="tab-pane" id="class-api-structure">
    ...
    <div role="tabpanel" class="tab-pane active" id="class-api-code">
